...
# Ensure that the filtering condition excludes exactly 0 Hz
# filter_indices = 

# Apply the filter to both channels
filtered_ft_data[0][(frequencies > noise_low) & (frequencies < noise_high)] = 0
filtered_ft_data[1][(frequencies > noise_low) & (frequencies < noise_high)] = 0
